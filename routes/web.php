...
Route::middleware(['manager'])->prefix('manager')->name('manager.')->group(function () {
    ...
    Route::get('/conges/historique', [ManagerCongeController::class, 'historique'])->name('conges.historique');
...
Route::middleware(['admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/employes', [AdminDashboardController::class, 'index'])->name('employes.index');

    Route::get('/competences', [AdminDashboardController::class, 'index'])->name('competences.index');
});
