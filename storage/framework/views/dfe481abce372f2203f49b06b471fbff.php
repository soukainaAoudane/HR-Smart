        ...
        <nav>
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->isEmploye()): ?>
                    ...
                    <a href="<?php echo e(route('employe.conge.create')); ?>" class="nav-link-sidebar">
                        <i class="fas fa-calendar-plus"></i>
                        <span>Demander congé</span>
                    </a>
                    <a href="<?php echo e(route('employe.conge.index')); ?>"
                        class="nav-link-sidebar <?php echo e(request()->routeIs('employe.conge.*') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        ...
        <div class="top-navbar">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Bienvenue, <?php echo e(Auth::user()->name); ?> 👋</h5>
                </div>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?php echo e(route('employe.profil')); ?>"><i
...
<?php /**PATH C:\gestionstagiaires\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>