            ...
            <div class="col-md-8">
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?php echo e(route('employe.deplacement.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\gestionstagiaires\resources\views/employe/deplacement/create.blade.php ENDPATH**/ ?>