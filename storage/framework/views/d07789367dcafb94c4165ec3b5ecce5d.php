...
<?php $component->withAttributes([]); ?>
                        ...
                        <div class="alert alert-info bg-light border-0 mb-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-primary fs-6 px-3 py-2 rounded-pill">
                                    <i class="fas fa-calendar-alt me-1"></i> <?php echo e(Auth::user()->conges_restants ?? 0); ?> jours
                                </span>
                            </div>
                        </div>

                        <form action="<?php echo e(route('employe.conge.store')); ?>"
                            method="POST"
    ...
    <script>
        document.getElementById('type').addEventListener('change', function() {
            ...
            const congesRestants =<?php echo e(Auth::user()->conges_restants); ?>;
...
<?php endif; ?><?php /**PATH C:\gestionstagiaires\resources\views/employe/conge/create.blade.php ENDPATH**/ ?>