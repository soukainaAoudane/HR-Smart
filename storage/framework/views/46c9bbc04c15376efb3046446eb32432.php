<?php $__env->startSection('title', 'Mes compétences'); ?>
...
<div class="container py-4">
    ...
    <div class="progress-card">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <span class="fw-bold" style="color: #1e3a5f;"><?php echo e($pourcentage); ?>%</span>
        </div>
        <div class="progress mb-2" style="height: 10px; border-radius: 10px; background: #e8edf2;">
            <div class="progress-bar-custom" style="width: <?php echo e($pourcentage); ?>%;"></div>
        </div>
        <small class="text-muted">
            <i class="fas fa-check-circle me-1 text-success"></i>
            <?php echo e($evaluees); ?> / <?php echo e($totalCompetences); ?> compétences évaluées
        </small>
    </div>

    <form method="POST" action="<?php echo e(route('employe.competences.update')); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="category-card">
                ...
                <div class="p-4">
                    <?php $__currentLoopData = $comps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $niveauActuel = $mesCompetences[$competence->id] ?? 0; ?>
                        ...
                        <div class="skill-card">
                            ...
                            <div class="d-flex align-items-start justify-content-between flex-wrap gap-2 mb-1">
                                ...
                                <?php if($niveauActuel > 0): ?>
                                    <span class="badge" style="background: #e0e7ff; color: #4f46e5; border-radius: 20px; font-size: 0.75rem;">
                                        Niveau <?php echo e($niveauActuel); ?> sélectionné
                                    </span>
                                <?php endif; ?>
                            </div>

                            <?php if($competence->description): ?>
                                <p class="text-muted small mb-3"><?php echo e($competence->description); ?></p>
                            <?php endif; ?>

                            
                            <div class="level-options">
                                <?php $__currentLoopData = [1 => 'Notions', 2 => 'Débutant', 3 => 'Intermédiaire', 4 => 'Avancé', 5 => 'Expert']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="level-option">
                                        <input
                                            type="radio"
                                            name="competences[<?php echo e($competence->id); ?>]"
                                            id="skill_<?php echo e($competence->id); ?>_<?php echo e($niveau); ?>"
                                            value="<?php echo e($niveau); ?>"
                                            <?php echo e($niveauActuel == $niveau ? 'checked' : ''); ?>

                                        >
                                        <label for="skill_<?php echo e($competence->id); ?>_<?php echo e($niveau); ?>">
                                            <span class="level-num"><?php echo e($niveau); ?></span>
                                            <span class="level-name"><?php echo e($label); ?></span>
                                        </label>
                                    </div>
        ...
        <div class="actions-card">
            ...
            <div class="d-flex justify-content-between flex-wrap gap-3">
                <a href="<?php echo e(route('employe.dashboard')); ?>" class="btn btn-outline-secondary rounded-3 px-4">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\gestionstagiaires\resources\views/employe/competences.blade.php ENDPATH**/ ?>